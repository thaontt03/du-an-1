 ...
 * @author AnhTiTan
 */
public class view_SachCT extends javax.swing.JFrame {

    /**
     * Creates new form view_SachCT
     */
...
//        loadText();
    ...
    private void initComponents() {
        ...
        layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {cbNCC, cbNXB, cbSach, cbTheLoai, jScrollPane1, txtGiaBan, txtGiaNhap, txtTacGia});
        ...
        layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {cbNCC, cbNXB, cbSach, cbTheLoai, txtGiaBan, txtGiaNhap, txtTacGia});
...
//            java.util.logging.Logger.getLogger(view_SachCT.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//        /* Create and display the form */
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new view_SachCT().setVisible(true);
            }
        });
    }
