 ...
 * @author Admin 88
 */
public class viewNV_NguoiDung extends javax.swing.JFrame {
...
//        loadText();
    ...
    private void initComponents() {
        ...
        tblND.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "Mã", "Họ Tên", "Giới Tính", "Ngày Sinh", "Địa Chỉ", "SĐT", "Mật Khẩu", "Chức Vụ", "Ngày Tạo", "Ngày Sửa", "Trạng Thái"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(viewNV_NguoiDung.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new viewNV_NguoiDung().setVisible(true);
            }
        });
    }
